...
<div class="flex flex-col gap-3">
  <div class="bg-base-200 rounded-lg px-4 pt-2 pb-1.5 flex flex-col gap-0">
    ...
    <div class="cols-3 flex-wrap gap-y-0.5">
      <label class="label cursor-pointer gap-1.5">
        ...
        />
        <span class="label-text-alt"> nickname </span>
      </label>
      ...
      <label class="label cursor-pointer gap-1.5">
        ...
        />
        <span class="label-text-alt"> magic links </span>
      </label>
      ...
      <label class="label cursor-pointer gap-1.5">
        ...
        />
        <span class="label-text-alt"> single sign-on</span>
      </label>
    </div>
    ...
    {#if client.allowFactor2 && advanced2fa}
      <label class="label cursor-pointer gap-1.5">
        <span class="label-text-alt ml-3"> OTP </span>
        <input
          type="checkbox"
          class="toggle toggle-xs"
      ...
      <label class="label cursor-pointer gap-1.5">
        <span class="label-text-alt ml-3"> SMS verification</span>
        <input
          type="checkbox"
          class="toggle toggle-xs"
      ...
      <label class="label cursor-pointer gap-1.5">
        <span class="label-text-alt ml-3"> Webauthn </span>
        <input
          type="checkbox"
          class="toggle toggle-xs"
      ...
      <label class="label cursor-pointer gap-1.5 ml-3">
        <span class="label-text-alt"> Backup codes</span>
        <input
          type="checkbox"
          class="toggle toggle-xs"
    ...
    <label class="label cursor-pointer gap-1.5">
      <span class="label-text-alt"> Profile management</span>
      <input
        type="checkbox"
        class="toggle toggle-xs"
    ...
    <label class="label cursor-pointer gap-1.5">
      <span class="label-text-alt"> Public discovery </span>
      <input
        type="checkbox"
        class="toggle toggle-xs"

...
module Masks
  class Actor < ApplicationRecord
    ...
    validates :login_email, presence: true, if: :email_required?
    ...
    def email_required?
      return true unless current_client
      return false unless current_client.allow_emails?
    ...
    def nickname_required?
      ...
      current_client.allow_nicknames?
    end

    def password_required?
      !current_client || current_client.allow_passwords?
    end

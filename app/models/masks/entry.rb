module Masks
  class Entry
    ...
    def enter!
      ...
      device_class = install.setting(:devices, :class, default: "Masks::Device").constantize

      session.structure do
        device device_class, expiry: device_class.cleanup_at || Masks::NEVER_EXPIRE
      end
      ...
      session.structure do
        current :entry,
                parent: :device,
                expiry: -> { client.expires_at(:authorization) }

...
module Masks
  class Provider < ApplicationRecord
    ...
    def assign_client=(v)
      client_providers.find_or_initialize_by(client: Masks.clients.discover(v))
    end

    def remove_client=(v)
      client = Masks.clients.discover(v)
    ...
    def callback_uri
      if persisted?
        Rails.application.routes.url_helpers.masks_sso_callback_url(
          self,

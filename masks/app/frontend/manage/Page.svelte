                    ...
                    >
                      <li class="rows menu-title text-base-content">
                        ...
                        <span
                          ...
                          /></span
                        >
                        <span class="divider my-0 mt-1.5 -mb-2 mx-0"></span>
                      </li>
                      <li>
                        <a class="whitespace-nowrap cols-3" href={root}
                          ><Home class="opacity-50" size="12" />Home</a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          href={`${root}/actors`}
                          ><User class="opacity-50" size="12" />Actors</a
                        >
                      </li>
                      <li>
                        <a
                          class="whitespace-nowrap cols-3"
                          href={`${root}/clients`}
                          ><DoorOpen class="opacity-50" size="12" />Clients</a
                        >
                      </li>
                      <li>
                        <a
                          class="whitespace-nowrap cols-3"
                          href={`${root}/tokens`}
                          ><Tickets class="opacity-50" size="12" />Tokens</a
                        >
                      </li>
                      <li>
                        <a
                      ...
                      <li class="py-1.5">
                        <button
                          ...
                          class={`whitespace-nowrap cols-3 btn btn-xs btn-neutral`}
                        >
                          {#if showSecrets}

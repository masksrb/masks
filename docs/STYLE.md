...
| Reference | Reference | `manage`, `browser`, `ruby`, and `rails` are generated by `./dev reference`. Never edit them by hand. `specs`, `words`, `design`, and `explorer` are written by hand. |

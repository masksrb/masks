...
## Masks::Client::Delegations::Refused
...
## Masks::Client::Delegations::Unavailable
...
```ruby
#exchange(subject_token, scope: nil, resource: nil, lifetime: nil, requested_token_type: nil, audience: nil)
```
...
```ruby
#start(resource: nil, prompt: nil, scope: nil, state: SecureRandom.urlsafe_base64(24), nonce: SecureRandom.urlsafe_base64(24), max_age: nil)
```

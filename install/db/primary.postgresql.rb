...
ActiveRecord::Schema[8.0].define(version: 2025_03_03_184046) do
  ...
  create_table "masks_client_providers", force: :cascade do |t|
    ...
    t.index ["provider_id", "client_id"], name: "index_masks_client_providers_on_provider_id_and_client_id", unique: true
  ...
  create_table "masks_devices", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_masks_devices_on_public_id", unique: true
  end
  ...
  create_table "masks_hardware_keys", force: :cascade do |t|
    ...
    t.index ["external_id", "aaguid"], name: "index_masks_hardware_keys_on_external_id_and_aaguid", unique: true
  end
  ...
  create_table "masks_otp_secrets", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_masks_otp_secrets_on_public_id", unique: true
  ...
  create_table "masks_single_sign_ons", force: :cascade do |t|
    ...
    t.index ["key", "provider_id"], name: "index_masks_single_sign_ons_on_key_and_provider_id", unique: true

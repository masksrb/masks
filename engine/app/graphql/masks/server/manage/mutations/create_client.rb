        ...
        class CreateClient < BaseMutation
          ...
          def resolve(name:, grant_types: [ Masks::Server::Client::CLIENT_CREDENTIALS ], required_scopes: [], allowed_scopes: [],
            ...
            client = Masks::Server::Client.new(
              ...
              response_types: Masks::Server::Client.response_types_for(grant_types),
            ...
            audit!(Masks::Server::Event::CLIENT_CREATED, client: client, name: client.name, grant_types: client.grant_types)

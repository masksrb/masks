    ...
    module Manage
      module Types
        class ClientType < BaseObject
          ...
          field :namespaces, [ "Masks::Server::Manage::Types::NamespaceType" ], null: false
          ...
          field :delegations, [ "Masks::Server::Manage::Types::DelegationType" ], null: false

          field :consents, [ "Masks::Server::Manage::Types::ConsentType" ], null: false do
            argument :limit, Integer, required: false
          end

          field :tokens, [ "Masks::Server::Manage::Types::TokenType" ], null: false do
            argument :limit, Integer, required: false
          end
          ...
          def tokens(limit: nil)
            Masks::Server::Token.where(kind: TokenType::GRANTS, client_id: object.id)
                   .live
          ...
          def delegations
            Masks::Server::Delegation.live.where(client_id: object.id).includes(:actor, connection: :provider).order(created_at: :desc)
          end

          def consents(limit: nil)
            Masks::Server::Consent.live

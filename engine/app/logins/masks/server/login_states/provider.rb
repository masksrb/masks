  ...
  module Server
    module LoginStates
      class Provider < LoginState
        ...
        def enabled?
          Masks::Server::Actor.exists? && offered.any?
        end
        ...
        private
          ...
          rescue Masks::Server::Provider::Untrusted, Masks::Server::Provider::Refused, Masks::Server::Provider::Unreachable, ArgumentError, OpenSSL::PKey::PKeyError => e
          ...
          def attach!
            ...
            provider = Masks::Server::Provider.signing_in.find_by(id: held["provider_id"])

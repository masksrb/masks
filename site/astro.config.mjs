      ...
      sidebar: [
        // Each item here is one entry in the navigation menu.
        {
          ...
          items: [
            ...
            { label: "Javascript", slug: "guides/intro" },
            { label: "Mobile apps", slug: "guides/intro" },
            { label: "Other languages", slug: "guides/intro" },
          ],
        },
        {
          label: "Guides",
        ...
        },
        {
          ...
          items: [
            ...
            { label: "HTTP APIs", link: "reference/http" },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { label: "HTTP + GraphQL", slug: "guides/rails" },
            { label: "Ruby/Rails", slug: "guides/rails" },
            { label: "JS/TS", slug: "guides/rails" },
          ],
        },
